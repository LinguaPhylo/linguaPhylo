...
\bibitem{zhang21}
Zhang R, Drummond AJ, Mendes FK.
\newblock Scalable {B}ayesian inference of phylogenies from molecular and
  continuous traits in a probabilistic total-evidence framework.
...
\newblock Molecular biology and evolution. 2022;in press.
