...
\begin{tabular}{ l | l | l }
    ...
    Coalescent & Kingman's coalescent tree prior\cite{Rodrigo1999SerialCoalescent} & RSV2.lphy \\  
    SkylineCoalescent & skyline coalescent prior\cite{drummond2005bayesiansequences} & hcv\_col.lphy\\  
    StructuredCoalescent & Structured coalescent prior\cite{muller2017structured} & simpleStructuredCoalescent.lphy\\  
    \hline
\end{tabular}
...
\begin{tabular}{ l | l | l }
    ...
    Yule & Yule tree\cite{yule1925ii} & simpleYule.lphy, yuleRelaxed.lphy\\  
    \hline
\end{tabular}
