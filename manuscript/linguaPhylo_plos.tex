...
\subsection{Example of data simulation using a phylogenetic model}

Model simulations can ever be easy using the LPhy Studio. This can be simply done by loading a LPhy script and then clicking the ``Sample" button. 
...
\begin{figure}
  ...
  \caption{A screenshot to run 100 simulations from the simple HKY+Coalescent model.} 
