...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\textwidth]{figs/lphystudio-gt16-mac.jpg}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.25\textwidth]{figs/gt16_EM_delta.pdf}
    \includegraphics[width=0.25\textwidth]{figs/gt16_EM_epsilon.pdf}
    \includegraphics[width=0.25\textwidth]{figs/gt16_EM_pi_0.pdf}
    \includegraphics[width=0.25\textwidth]{figs/gt16_EM_rates_ac.pdf}
    \includegraphics[width=0.25\textwidth]{figs/gt16_EM_treeheight.pdf}
    \includegraphics[width=0.25\textwidth]{figs/gt16_EM_treelength.pdf}
