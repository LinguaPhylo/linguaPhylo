...
We demonstrate LPhy's main features using an example script for performing phylogenetic inference on a virus dataset (Example \ref{lphy:rsva}). 
This dataset contains sequences of the Respiratory syncytial virus subgroup A (RSVA). 
The accompanying tutorial ``Time-sampled data'' for this script is available at 
