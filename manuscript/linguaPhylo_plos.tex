...
\section{Results}
We present key features of the LPhy software using two models from the Phylonco package \cite{chen2022accounting} developed for singel-cell data - the GT16 substitution model \cite{kozlov2022cellphy} and the GT16 error model \cite{kozlov2022cellphy}. 
...
Bayesian model validation consists of a series of steps, the first of which is simulation of synthetic data. Recent examples within the BEAST 2 platform include \cite{gaboriau20,chen2022accounting}. 
