...
In the example above, the generators \texttt{migrationMatrix} is a deterministic function and \texttt{StructuredCoalescent} is a generative distribution. 
...
More detail are dicussed in the Data clamping section.
