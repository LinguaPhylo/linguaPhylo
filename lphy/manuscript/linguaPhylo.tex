...
crisis'' \citep{baker16,fanelli18} in many disciplines, among which the
dimension of the problem varies.
In psychology, for example, replication attempts were successful in
only 36\% of surveyed studies \citep{openscience15}, with numbers
being less discouraging in economics (61.1\%; \citep{camerer16}).
