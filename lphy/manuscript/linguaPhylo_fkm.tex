...
In this paper we describe two related project, LinguaPhylo (LPhy for
short) and LPhyBEAST.  
...
Each of the lines in this specification expresses how a random
...
\cite{carpenter2017stan}, BUGS and Stan that provide the possibility
of succinctly describing statistical models. The unique feature of
...
As a result specialist software is needed to perform inference.

The aim of LPhy is describe the standard phylogenetic tree
distributions succinctly and precisely.
