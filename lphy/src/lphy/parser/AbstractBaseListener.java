...
public class AbstractBaseListener extends SimulatorBaseListener {
    ...
    static {
        ...
        Class<?>[] genClasses = {RhoSampleTree.class, BernoulliMulti.class, BirthDeathTree.class, BirthDeathTreeDT.class,
                BirthDeathSamplingTree.class, BirthDeathSamplingTreeDT.class, ExpMarkovChain.class, ExtantBirthDeathTree.class, InverseGamma.class,
        ...
        Class<?>[] functionClasses = {ARange.class, ArgI.class, DataFrameConstruction.class, DataFramePart.class,
                ...
                MigrationCount.class, Range.class, RootAge.class, TaxaFunction.class, TreeLength.class, DihedralAngleDiffusionMatrix.class,
                Nexus.class
        };
