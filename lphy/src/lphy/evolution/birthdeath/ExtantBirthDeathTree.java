 ...
 */
public class ExtantBirthDeathTree extends TaxaConditionedTreeGenerator {
    ...
    public ExtantBirthDeathTree(@ParameterInfo(name = "lambda", description = "per-lineage birth rate.") Value<Number> birthRate,
    ...
    @GeneratorInfo(name = "ExtantBirthDeath", description = "A tree of only extant species, simulated from a full species tree produced by a speciation-extinction (birth-death) branching process.<br>" +
