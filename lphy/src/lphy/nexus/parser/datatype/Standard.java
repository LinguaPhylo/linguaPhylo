...
public class Standard extends DataType {
    ...
    public static final String DESCRIPTION = "standard";
    public static final int TYPE = GENERAL;
    public static final Standard INSTANCE = new Standard(); // not used?
     ...
     */
    public Standard(final String[] stateCodes) {
     ...
     * @param stateCodes the codes of the states
     */
    public Standard(final Collection<String> stateCodes) {
        int i = 0;
