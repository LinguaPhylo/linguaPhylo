...
//            }
        ...
        public Value visitStoch_relation(SimulatorParser.Stoch_relationContext ctx) {
            ...
            if (var.getId() != null && parser.getDataDictionary().containsKey(var.getId())) {
                ...
                //TODO Alignment, require to reorder
//                if (valueVal instanceof Alignment alignment && genDist instanceof PhyloCTMC) {
//                    // re-order taxa
//                    SortedMap<String, Integer> idMap = new TreeMap<>();
//                    fillIdMap(tree.value().getRoot(), idMap);
//                    Alignment a = new SimpleAlignment(alignment.nchar(), alignment);
//                    variable =
//                } else
//                    throw new UnsupportedOperationException("Clamp is not implemented for " + var.getId() +
//                            " generated by " + genDist.getName() + ", type = " + valueVal.getClass());
