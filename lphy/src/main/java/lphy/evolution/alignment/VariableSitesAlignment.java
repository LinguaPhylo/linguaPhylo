...
public class VariableSitesAlignment extends DeterministicFunction<Alignment> {
    ...
    public VariableSitesAlignment(@ParameterInfo(name = AlignmentUtils.ALIGNMENT_PARAM_NAME,
    ...
    @GeneratorInfo(name = "variableSitesAlignment",
            category = GeneratorCategory.TAXA_ALIGNMENT,
            description = "Remove all constant sites, where the unknown state (include gaps) can be either ignored or not.")
