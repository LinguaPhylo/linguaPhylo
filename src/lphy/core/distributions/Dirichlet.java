...
public class Dirichlet implements GenerativeDistribution<Double[]> {
    ...
    public Dirichlet(@ParameterInfo(name=concParamName, description="the concentration parameters of a Dirichlet distribution.", type=Number[].class) Value<Number[]> concentration) {
