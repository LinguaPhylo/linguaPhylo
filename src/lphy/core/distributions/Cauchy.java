...
public class Cauchy implements GenerativeDistribution<Double> {
    ...
    public Cauchy(@ParameterInfo(name = "mean", description = "the mean of the Cauchy distribution.") Value<Double> mean,
                  @ParameterInfo(name = "scale", description = "the scale of the Cauchy distribution.") Value<Double> scale) {
