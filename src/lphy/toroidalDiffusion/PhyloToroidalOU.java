 ...
 */
public class PhyloToroidalOU extends PhyloMultivariateBrownian {
    ...
    public PhyloToroidalOU(@ParameterInfo(name = "tree", description = "the time tree.") Value<TimeTree> tree,
