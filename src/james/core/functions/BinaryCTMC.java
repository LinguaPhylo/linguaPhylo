 ...
 */
public class BinaryCTMC extends DeterministicFunction<Double[][]> {

    String paramName;

    public BinaryCTMC(@ParameterInfo(name = "lambda", description = "the lambda parameter of the binary process. Rate of 0->1 is 1, rate of 1->0 is lambda.") Value<Double> kappa) {
        paramName = getParamName(0);
        setParam(paramName, kappa);
    }


    @FunctionInfo(name = "binaryCTMC", description = "The binary trait instantaneous rate matrix. Takes a lambda and produces a instantaneous rate matrix.")
