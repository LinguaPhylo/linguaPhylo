...
public class ColtEigenSystem implements EigenSystem {
    ...
    public EigenDecompositionExt decomposeMatrix(Double[][] Qmatrix) {

        final int stateCount = Qmatrix.length;
        ...
        return new EigenDecompositionExt(flatEvec, flatIevc, Eval);
    }

    public double computeExponential(EigenDecompositionExt eigen, double distance, int i, int j) {
        if (eigen == null) {
            return 0.0;
        }
    ...
    public void computeExponential(EigenDecompositionExt eigen, double distance, double[] matrix) {
        double temp;
...
//             if (EvalImag[i] == 0) {
 ...
 //             }
    ...
    protected EigenDecompositionExt getEmptyDecomposition(int dim) {
        return new EigenDecompositionExt(
                new double[dim * dim],
                new double[dim * dim],
