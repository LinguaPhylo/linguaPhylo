...
//            this.maxIterations = maxIterations;
              ...
              for (int k = 0; k < Math.max(nct,nrt); k++) {
                         if (k < nct) {
                                ...
                                s[k] = 0;
                                for (int i = k; i < m; i++) {
                                   s[k] = RobustEigenDecomposition.hypot(s[k],A[i][k]);
                                }
                                if (s[k] != 0.0) {
                                   if (A[k][k] < 0.0) {
                                              s[k] = -s[k];
                         ...
                         if (k < nrt) {
                                ...
                                e[k] = 0;
                                for (int i = k+1; i < n; i++) {
                                   e[k] = RobustEigenDecomposition.hypot(e[k],e[i]);
                                }
                                if (e[k] != 0.0) {
                                   if (e[k+1] < 0.0) {
                                              e[k] = -e[k];
                  ...
                  if (iter > maxIterations)
                         ...
                         switch (kase) {
                                ...
                                case 1: {
                                   ...
                                   e[p-2] = 0.0;
                                   for (int j = p-2; j >= k; j--) {
                                              double t = RobustEigenDecomposition.hypot(s[j],f);
                                              double cs = s[j]/t;
                                              double sn = f/t;
                                              s[j] = t;
                                              if (j != k) {
                                ...
                                case 3: {
                                   ...
                                   for (int j = k; j < p-1; j++) {
                                              double t = RobustEigenDecomposition.hypot(f,g);
                                              double cs = f/t;
                                              double sn = g/t;
                                              if (j != k) {
                                                     e[j-1] = t;
                                              ...
                                              t = RobustEigenDecomposition.hypot(f,g);
                                              cs = f/t;
                                              sn = g/t;
                                              s[j] = t;
                                              f = cs*e[j] + sn*s[j+1];
