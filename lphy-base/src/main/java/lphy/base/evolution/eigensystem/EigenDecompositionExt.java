 ...
 */
public class EigenDecompositionExt {

    public EigenDecompositionExt(double[] evec, double[] ievc, double[] eval) {
        Evec = evec;
        Ievc = ievc;
        Eval = eval;
        Evali = null;
    ...
    public EigenDecompositionExt(double[] evec, double[] ievc, double[] eval, double[] evali) {
        Evec = evec;
        Ievc = ievc;
        Eval = eval;
    ...
    public EigenDecompositionExt copy() {
        double[] evec = Evec.clone();
        double[] ievc = Ievc.clone();
        double[] eval = Eval.clone();

        return new EigenDecompositionExt(evec, ievc, eval);
    }
