...
public class LPhyBaseImpl extends LPhyCoreImpl { //implements LPhyExtension {
    ...
    public List<Class<? extends BasicFunction>> declareFunctions() {
        return Arrays.asList(ARange.class, ArgI.class,
                ...
                SubstituteClade.class,//NodeCount.class, TreeLength.class,
                // Matrix
                ...
                // Math
                SumBoolean.class, SumRows.class, SumCols.class, Sum2dArray.class, Sum.class, Difference.class,// Product.class,
                // Set Op
                Intersect.class,
                // cast
                ToDouble.class,
