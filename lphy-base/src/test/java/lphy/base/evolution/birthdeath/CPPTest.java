...
public class CPPTest {
    ...
    void testCPP() {
        ...
        CalibratedCPPTree cpp = new CalibratedCPPTree(birthRate, deathRate, samplingProb, n, cladeTaxa, cladeMRCAAge, null, null);
...
//                    System.out.println(children[2]);
    ...
    void testCPP2() {
        ...
        CalibratedCPPTree cpp = new CalibratedCPPTree(birthRate, deathRate, samplingProb, n, cladeTaxa, cladeMRCAAge, new Value<>("",10), null);
        TimeTree cppTree = cpp.sample().value();
